...
(function () {
  ...
  /* Counts are formatted rather than concatenated. At today's sizes this is
     ...
     from 155 to 215 in two months and will cross a thousand, and that is the
     point where a hand-built string starts printing "1215" to a reader whose
     locale wants "1,215". Falls back to the raw number on a browser without
