...
window.DB.research = [
  /* ═══════════════ INDIA — PAID, FREE TO APPLY, OPEN TO CURRENT STUDENTS ═══════════════ */
  {
    ...
    duration: "2 months",
    window: "Registration historically 10 Dec – 10 Jan · results Aug–Sept",
    deadlineMonths: [12, 1],
    ...
    steps: [
      ...
      "Registration has historically opened around 10 December and closed 10 January. Do not rely on hearing about it — set the reminder yourself.",
  ...
  },
  {
    ...
    window: "Applications open Nov · close mid-Dec",
